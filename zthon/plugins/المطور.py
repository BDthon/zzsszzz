...
ZelzalDV_cmd = (
    "𓆩 [𝗦َ𝙤𝙐!𝙧𝘾𝙚َ 𝘽ِ𝘿َ𝗧𝙃َ𝙤𝙉ِِ 𝗖𝗼𝗻𝗳𝗶𝗴 - اوامــر المطـور المســاعد](t.me/BDthon) 𓆪\n\n"
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت بدثـــــــون انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت بدثـــــــون انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
