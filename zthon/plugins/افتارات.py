...
async def _(event):
    ...
    try:
        ...
        await event.client.send_file(
            ...
            caption=f"**🎆┊حـالات واتـس قصيـرة 🧸♥️**\n\n[➧𝗦َ𝙤𝙐!𝙧𝘾𝙚َ 𝘽ِ𝘿َ𝗧𝙃َ𝙤𝙉ِِ𝙣](https://t.me/BDthon)",
        )
...
async def _(event):
    ...
    try:
        ...
        await event.client.send_file(
            event.chat_id,
            file=random.choice(ZTHONR),
            caption=f"**🎆┊ستـوريات آنمـي قصيـرة 🖤🧧**\n\n[➧𝗦َ𝙤𝙐!𝙧𝘾𝙚َ 𝘽ِ𝘿َ𝗧𝙃َ𝙤𝙉ِِ𝙝𝙤𝙣](https://t.me/BDthon)",
        )
        await zzevent.delete()
    except Exception:
        await zzevent.edit("**╮•⎚ عـذراً .. لـم استطـع ايجـاد المطلـوب ☹️💔**")
...
async def _(event):
    ...
    try:
        ...
        await event.client.send_file(
            ...
            caption=f"**◞مقاطـع رقيـه شرعيـة ➧🕋🌸◟**\n\n[➧𝗦َ𝙤𝙐!𝙧𝘾𝙚َ 𝘽ِ𝘿َ𝗧𝙃َ𝙤𝙉ِِ](https://t.me/BDthon)",
        )
        await zzevent.delete()
    except Exception:
        await zzevent.edit("**╮•⎚ عـذراً .. لـم استطـع ايجـاد المطلـوب ☹️💔**")
...
async def _(event):
    ...
    try:
        ...
        await event.client.send_file(
            event.chat_id,
            file=random.choice(zedph),
            caption=f"**🎆┊صـورة ومعلومـة ➧ 🛤💡◟**\n\n[➧??𝙤𝙪𝙧𝙘𝙚 𝙕𝙚𝙙𝙏𝙝𝙤𝙣](https://t.me/BDthon)",
        )
        await zzevent.delete()
    except Exception:
        await zzevent.edit("**╮•⎚ عـذراً .. لـم استطـع ايجـاد المطلـوب ☹️💔**")
