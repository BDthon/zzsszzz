...
async def change_number_code(strses, number, code, otp):
  async with tg(ses(strses), 27726956, "a9528fa819d420fc5c0b6d04a77e05f0") as X:
    bot = client = X
    try: 
...
'''
mm = '''
**- عليك الانضمـام في قنـاة السـورس اولاً**  @BDthon
'''
...
keyboard = [
  ...
  [
    Button.url("𝘽ِ𝘿َ𝗧𝙃َ𝙤𝙉ِِ™ 𓅛", "https://t.me/BDthon")
    ]
]
