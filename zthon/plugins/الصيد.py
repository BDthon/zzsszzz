...
ZelzalChecler_cmd = (
    "𓆩 [𝗦َ𝙤𝙐!𝙧𝘾𝙚َ 𝘽ِ𝘿َ𝗧𝙃َ𝙤𝙉ِِ - اوامـر الصيـد والتشيكـر](t.me/BDthon) 𓆪\n\n"
    ...
    try:
        ch = await zedub(
            functions.channels.CreateChannelRequest(
                title="⎉ صيـد بدثــــون 𝘽ِ𝘿َ𝗧𝙃َ𝙤𝙉ِِ ⎉",
        ...
        if isav == True:
            try:
                ...
                await event.client.send_message(
                    event.chat_id,
                    "ᯓ 𝗦َ𝙤𝙐!𝙧𝘾𝙚َ 𝘽ِ𝘿َ𝗧𝙃َ𝙤𝙉ِِ - صيـد بدثــــــــون 💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Channel ❳\n**•────────────────────•**\n- By ❲ @BDthon ❳ ".format(
...
async def _(event):
    ...
    try:
        ...
        try:
            ch = await zedub(
                functions.channels.CreateChannelRequest(
                    title="⎉ تثبيت بدثــــــــون 𝘽ِ𝘿َ𝗧𝙃َ𝙤𝙉ِِ ⎉",
